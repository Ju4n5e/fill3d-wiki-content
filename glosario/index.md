...
**Definición:** La **temperatura de transición vítrea** (Tg) es la temperatura a la que un polímero amorfos pasa de un estado rígido a un estado más blando y gomoso sin llegar a fundirse. Es el límite práctico de temperatura de servicio de una pieza impresa: por encima de la Tg la pieza puede deformarse bajo carga.
