...
El PP es un polímero **semicristalino** con densidad muy baja (~0.9 g/cm³ — flota en agua), excelente **resistencia química** a ácidos, bases y la mayoría de solventes orgánicos, y una resistencia única a la **fatiga por flexión cíclica**: puede doblarse decenas de miles de veces en el mismo punto sin romperse. Su temperatura de servicio llega a ~100–110 °C bajo carga ligera. ⚠️ verificar especificaciones exactas del FiLL-3D PP.

### Parámetros de impresión recomendados — FiLL-3D PP

| Parámetro | Valor recomendado | Notas |
|---|---|---|
| Temperatura de boquilla | 220–240 °C ⚠️ verificar | |
| Temperatura de cama | 100–115 °C ⚠️ verificar | Cama muy caliente, obligatoria |
| Velocidad de impresión | 20–40 mm/s ⚠️ verificar | Lento para minimizar warping |
| Enfriamiento | 50–80 % ⚠️ verificar | |
| Retracción | 2–4 mm a 35 mm/s ⚠️ verificar | |
